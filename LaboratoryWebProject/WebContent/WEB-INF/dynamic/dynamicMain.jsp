 ...
 */
	...
	/**下面定义不同的子页面链接**/
	$menuURIOne = "frontDynamicAction_part?section=1";
	$menuURITwo = "frontDynamicAction_part?section=2";
	$menuURIThree = "frontDynamicAction_part?section=3";
	$menuURIFour = "frontDynamicAction_part?section=4";
	/**下面定义间隔线的四种不同的样式**/
...
<!--=========左边框架===========  -->
	<div class="freamLeft">	
		<div class="tabTitle">
			<ul id="tabsecond">
			<!-- 二级菜单 -->
				<li class="tabOne">行业动态</li>
				<li class="tabTwo">实验室新闻</li>
				<li class="tabThree">创新文化</li>
				<li class="tabFour">通知公告</li>
			</ul>
		</div>

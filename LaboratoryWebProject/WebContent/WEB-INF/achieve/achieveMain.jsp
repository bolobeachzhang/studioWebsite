...
<html>
<head>
<title>成都大学-模式识别与智能信息处理四川省高校重点实验室-科研成果</title>
 ...
 */
	...
	/**下面定义不同的子页面链接**/
	$menuURIOne = "frontAchieveAction_part?section=1";
	$menuURITwo = "frontAchieveAction_part?section=2";
	$menuURIThree = "frontAchieveAction_part?section=3";
	/**下面定义间隔线的四种不同的样式**/
...
<!--=========左边框架===========  -->
	<div class="freamLeft">	
		<div class="tabTitle">
			<ul id="tabsecond">
			<!-- 二级菜单 -->
				<li class="tabOne">科研论文</li>
				<li class="tabTwo">获奖情况</li>
				<li class="tabThree">其他成果</li>
			</ul>
		</div>

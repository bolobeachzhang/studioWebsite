...
<script type="text/javascript">
	...
	//选中期刊类型
	function mselectType(type){
		$("input[name='thesis.type'][value='"+type+"']").attr("checked",true);
	}
	//选中下载权限
	function mselectDownrole(type){
		$("input[name='thesis.downrole'][value='"+type+"']").attr("checked",true);
	}
</script>
<style type="text/css">
	.mTable{
...
<body>
	...
	<table id="table"  class="table table-striped table-bordered mTable">
		...
		<tr><td>论文类型：</td><td>
								...
								<c:out value='<script type="text/javascript"> mselectType(${requestScope.thesis.type });</script>' escapeXml="false"></c:out>
								<span class="redstr">*</span>
							  </td></tr>
		...
		<tr><td>论文摘要：</td><td><textarea id="digest" name="thesis.digest" max="4000">${requestScope.thesis.digest }</textarea><span class="redstr">*</span><span id="rdigest"></span></td></tr>
		<tr><td>下载权限：</td><td>
								...
								<c:out value='<script type="text/javascript"> mselectDownrole(${requestScope.thesis.downrole });</script>' escapeXml="false"></c:out>
								<span class="redstr">*</span>
							  </td></tr>
		...
		<tr><td colspan="2"><input type="submit" class="btn" value="确认修改" style="margin-left: 150px;margin-right: 20px;"> <input type="reset" class="btn" value="重置修改"></td></tr>
	</table>
	</form>
</body>
</html>
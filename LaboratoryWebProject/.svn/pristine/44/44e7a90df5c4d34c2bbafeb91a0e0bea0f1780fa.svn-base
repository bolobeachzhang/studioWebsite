...
<body>
	...
	<div id="paging">
		...
		<c:if test="${requestScope.pageNow > 1}">
			<a fff="frontIndexAction_part?section=1&pageNow=${requestScope.pageNow - 1 }" onclick="pageQuery(this)">上一页</a>&nbsp; 
		</c:if>
		...
		<c:if test="${requestScope.pageCount != 1}">  
		    ...
		    <c:if test="${requestScope.pageNow < requestScope.pageCount}">
				<a fff="frontIndexAction_part?section=1&pageNow=${requestScope.pageNow + 1 }" onclick="pageQuery(this)">下一页</a>&nbsp; 
			</c:if>
		</c:if>  
	</div>
	<!-- ==================================分页结束======================================== -->

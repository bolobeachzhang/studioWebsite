...
<div id="operation">
	 <ul class="firstItem">
		...
		<li class="clickItem" action="managePersonAction_updateT" >&nbsp;•&nbsp;&nbsp;个人信息</li>
		...
		<li class="clickItem" action="manageMessageAction_showTUncheck">&nbsp;•&nbsp;&nbsp;未回复留言
			<ul class="secondItem">
				<li class="clickItem" action="manageMessageAction_showTUnchecked">&lt;&nbsp;已回复留言</li>
			</ul>
		</li>
		<li class="clickItem" action="manageThesisAction_getT">&nbsp;•&nbsp;&nbsp;我的论文
			<ul class="secondItem">
				<li class="clickItem" action="manageThesisAction_upload">&lt;&nbsp;上传论文</li>
			</ul>
		</li>
	</ul>
</div>

...
<!-- ==================================分页开始======================================== -->
	<div id="paging">
		...
		<c:if test="${requestScope.pageNow >1}">
			<a fff="frontExchangeAction_part?section=3&pageNow=${requestScope.pageNow-1}" onclick="pageQuery(this)" style="cursor:pointer;">上一页</a>&nbsp; 
		</c:if>
		<a fff="frontExchangeAction_part?section=3&pageNow=1" onclick="pageQuery(this)" style="cursor:pointer;">[1]</a>&nbsp;  
		<c:if test="${requestScope.pageCount != 1}">  
		    ...
		    <c:choose>  
		        ...
		        <c:otherwise>  
		            ...
		            ...&nbsp;  
		            <a fff="frontExchangeAction_part?section=3&pageNow=${requestScope.pageCount}" onclick="pageQuery(this)" style="cursor:pointer;">  

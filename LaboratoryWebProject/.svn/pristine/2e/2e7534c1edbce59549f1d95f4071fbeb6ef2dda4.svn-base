...
<html>
<head>
<title>成都大学-模式识别与智能信息处理四川省高校重点实验室-合作交流</title>
...
$(document).ready(function(){
	 ...
	 */
		...
		/**下面定义不同的子页面链接**/
		$menuURIOne = "frontExchangeAction_part?section=1";
		$menuURITwo = "frontExchangeAction_part?section=2";
		$menuURIThree = "frontExchangeAction_part?section=3";
		$menuURIFour = "frontExchangeAction_part?section=4";
		/**下面定义三级菜单的链接**/
		$subMenuURIOne = "frontExchangeAction_separt?section=1";
		$subMenuURITwo = "frontExchangeAction_separt?section=2";
		/**下面定义间隔线的四种不同的样式**/
...
<!--=========左边框架===========  -->
	<div class="freamLeft">	
		<div class="tabTitle">
			<ul id="tabsecond">
			<!-- 二级菜单 -->
				<li class="tabOne">开放课题</li>
				<li class="tabTwo">合作项目</li>
				<li class="tabThree">学术交流<b></b></li>
				<li class="tabFour">学术论坛</li>
			</ul>
		</div>

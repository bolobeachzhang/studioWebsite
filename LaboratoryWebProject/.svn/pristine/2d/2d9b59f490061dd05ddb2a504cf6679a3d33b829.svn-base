...
<html>
<head>
<title>成都大学-模式识别与智能信息处理四川省高校重点实验室-下载中心</title>
 ...
 */  
	...
	/**下面定义不同的子页面链接**/
	$menuURIOne = "frontDownloadAction_part?section=1";
	$menuURITwo = "frontDownloadAction_part?section=2";
	$menuURIThree = "frontDownloadAction_part?section=3";
	/**下面定义间隔线的四种不同的样式**/
...
<!--=========左边框架===========  -->
	<div class="freamLeft">
		<div class="tabTitle">
			<ul id="tabsecond">
			<!-- 二级菜单 -->
				<li class="tabOne">课件下载</li>
				<li class="tabTwo">工具下载</li>
				<li class="tabThree">相关表单</li>
			</ul>
		</div>
...
<!-- ===========右边框架 ===============-->
	...
	</div><!-- end freamRight --><!-- end freamRight -->
</div><!-- end fream -->
</body>
</html>

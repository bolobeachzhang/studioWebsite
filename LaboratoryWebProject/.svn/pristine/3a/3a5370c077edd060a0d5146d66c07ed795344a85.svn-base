...
<html>
<head>
<title>成都大学-模式识别与智能信息处理四川省高校重点实验室-实验室介绍</title>
...
<script type="text/javascript">
	 ...
	 */
		...
		/**下面定义不同的子页面链接**/
		$menuURIOne = "frontIntroduceAction_part?section=1";
		$menuURITwo = "frontIntroduceAction_part?section=2";
		$menuURIThree = "frontIntroduceAction_part?section=3";
		$menuURIFour = "frontIntroduceAction_part?section=4";
		/**下面定义间隔线的四种不同的样式**/
...
<!--=========左边框架===========  -->
	<div class="freamLeft">	
		<div class="tabTitle">
			<ul id="tabsecond">
			<!-- 二级菜单 -->
				<li class="tabOne">实验室概况</li>
				<li class="tabTwo">组织机构</li>
				<li class="tabThree">学术带头人</li>
				<li class="tabFour">实验室主任</li>
			</ul>
		</div>
